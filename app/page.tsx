...
export default function Home() {
  return (
    <div className="flex relative flex-col items-center justify-center w-screen h-screen overflow-hidden bg-[#0f0f0f] ">
      ...
      <h1 className={`z-10 font-semibold   text-5xl text-transparent duration-1000 bg-gradient-to-t from-[#dadbdd] to-[#c4c2c2] cursor-default animate-title sm:text-6xl md:text-8xl whitespace-nowrap bg-clip-text`}>
        Hi, Sandro hier
      </h1>
      </div>
